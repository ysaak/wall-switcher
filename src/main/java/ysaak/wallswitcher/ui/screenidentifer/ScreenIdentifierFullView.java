package ysaak.wallswitcher.ui.screenidentifer;
...
public final class ScreenIdentifierFullView {
    ...
    public static void showScreenIdentifier(List<ScreenDto> screens) {
        ...
        delay.setOnFinished( event -> {
            windowList.forEach(ScreenIdentifierFullView::closeWindow);
    ...
    private static Popup createAndShowStage(ScreenDto screen) {
        ...
        Rectangle rect2 = new Rectangle(0, 0, 1000, 700);
        ...
        layout.getChildren().addAll(rect2, text);
